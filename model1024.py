...
train_data = MyDataset(txt =root+'data1024.txt',transform = transforms.ToTensor())
...
class CNN1024(nn.Module):
     def __init__(self):
          super(CNN1024, self).__init__()
...
cnn = CNN1024()
cnn.load_state_dict(torch.load('1024cnn_params.pkl'))
...
for epoch in range(EPOCH):
     ...
     torch.save(cnn.state_dict(),"1024cnn_params.pkl")
