...
train_data = MyDataset(txt =root+'data2048.txt',transform = transforms.ToTensor())
...
cnn.load_state_dict(torch.load('2048cnn_params.pkl'))
...
for epoch in range(EPOCH):
     ...
     torch.save(cnn.state_dict(),"2048cnn_params.pkl")
