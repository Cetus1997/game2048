...
train_data = MyDataset(txt =root+'data512.txt',transform = transforms.ToTensor())
...
cnn = CNN512()
cnn.load_state_dict(torch.load('512cnn_params.pkl'))
...
for epoch in range(EPOCH):
     ...
     torch.save(cnn.state_dict(),"512cnn_params.pkl")
